...
public class KafkaConfig {
    ...
    public NewTopic paymentCompletedEvent() {
        return TopicBuilder.name("payment-completed-events")
                .partitions(3)
                .replicas(3)
    ...
    @Bean
    public NewTopic paymentFailedEvent() {
        return TopicBuilder.name("payment-failed-events")
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .config(TopicConfig.RETENTION_MS_CONFIG, "86400000")
    ...
    @Bean
    public NewTopic orderCreatedEvents() {
